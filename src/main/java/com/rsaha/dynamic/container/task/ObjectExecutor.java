...
public class ObjectExecutor implements Callable<Boolean>{
	
	private static final String EXECUTION_FILE_NAME = "execution-file";
	private List<File> filesToBeExecuted;
	...
	public ObjectExecutor(List<File>filesToBeExecuted){
		this.filesToBeExecuted = filesToBeExecuted;
	...
	public void run(){
		...
		Map<String,GenericCodeReaderFromFile> javaCodeReaderFiles = AppLauncher.createMapOfFileAndReaderObjects(filesToBeExecuted, srcPath.length());
